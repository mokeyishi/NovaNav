...
const BookmarkCard: React.FC<BookmarkCardProps> = ({ bookmark }) => {
  return (
    ...
    >
      <div className="flex-shrink-0 w-11 h-11 rounded-xl bg-slate-100 flex items-center justify-center p-2 group-hover:scale-110 transition-transform duration-500 shadow-sm mr-4 overflow-hidden">
        <img 
          src={bookmark.icon} 
          alt={bookmark.name} 
