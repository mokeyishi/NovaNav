...
export const INITIAL_BOOKMARKS: Bookmark[] = [
  ...
  { id: '2', categoryId: 'tools', name: '背景墙制作', url: 'https://images-edit.vercel.app/', description: '制作背景墙', icon: 'https://raw.githubusercontent.com/mokeyishi/images/refs/heads/master/img/clapp.ico' },
